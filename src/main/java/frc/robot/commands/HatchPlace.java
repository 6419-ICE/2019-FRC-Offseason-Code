...
public class HatchPlace extends Command implements PIDOutput {
  ...
  public HatchPlace(double targetOffset, double driveSpeed) {
  ...
  protected void execute() {
    Robot.drivetrain.drive(driveSpeed + pidOutput, driveSpeed - pidOutput);
  }
